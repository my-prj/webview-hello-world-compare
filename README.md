...
| Neutralinojs | https://github.com/neutralinojs/neutralinojs | 2840 KB local, CI pending | JSON, HTML | neutralinojs 6.9.0 + neu CLI 11.7.2; ~28M under `temp/neutralinojs/` | T1=78s, T2=2s (build.sh), T3=195s, T4 pending; local `.app` 2840 KB; CI pending; [CI run](https://github.com/my-prj/webview-hello-world-compare/actions/runs/31963765822) |
